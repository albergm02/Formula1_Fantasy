...
const perfilesPuntuacion = {
  ...
  todo_terreno: {
    ...
    reglasUsuario: [
      ...
      'Si el piloto no sale (N/S), abandona (DNF) o es descalificado (DSQ) → ×0.50 (no puntúa el caos).',
  ...
  estratega: {
    ...
    reglasUsuario: [
      ...
      'Si el piloto no sale (N/S), abandona (DNF) o es descalificado (DSQ) → ×0.50 (no puntúa la estrategia).',
      'Factor acotado al rango 0.50 – 1.50.',
    ],
  },
}
