...
const perfilesPuntuacion = {
  ...
  todo_terreno: {
    ...
    reglasUsuario: [
      ...
      'Cada abandono en carrera → +0.10',
      'Si el piloto no sale (N/S), abandona (ABN) o es descalificado (DESC) → ×0.50 (no puntúa el caos).',
  ...
  remontador: {
    ...
    reglasUsuario: [
      ...
      'Si el piloto no sale (N/S), abandona (ABN) o es descalificado (DESC) → ×0.50 (no puntúa el diferencial).',
      'Factor acotado al rango 0.50 – 1.50.',
    ],
  },
  estratega: {
    ...
    reglasUsuario: [
      ...
      'Si el piloto no sale (N/S), abandona (ABN) o es descalificado (DESC) → ×0.50 (no puntúa la estrategia).',
      'Factor acotado al rango 0.50 – 1.50.',
    ],
  },
}
