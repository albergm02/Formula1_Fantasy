...
export const perfilesPuntuacion = {
  qualy: {
    ...
    reglasUsuario: [
      ...
      'Adaptabilidad x0.1 — muy poco peso, no importa el clima o la estrategia.',
    ],
  },
  carrera: {
    clave: 'carrera',
    ...
    reglasUsuario: [
      'Consistencia x0.6 — gran importancia por terminar bien cada carrera.',
  ...
  todo_terreno: {
    ...
    reglasUsuario: [
      ...
      'Ritmo x0.2 — la velocidad base aporta algo.',
      'Consistencia x0.2 — la regularidad en carrera tiene menos peso.',
    ],
  },
  base: {
    clave: 'base',
    ...
    pesos: { ritmo: 0.3, consistencia: 0.4, adaptabilidad: 0.3 },
    reglasUsuario: [
      'Ritmo x0.3 — contribucion equilibrada de velocidad.',
      'Consistencia x0.4 — contribucion equilibrada de regularidad.',
