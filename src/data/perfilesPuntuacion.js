...
export const perfilesPuntuacion = {
  ...
  remontador: {
    ...
    reglasUsuario: [
      'Factor según adelantamientos reales (OpenF1 /overtakes):',
      '14+ adelantamientos → ×1.45',
      '10 – 13 adelantamientos → ×1.30',
      '7 – 9 adelantamientos → ×1.15',
      '4 – 6 adelantamientos → ×1.00',
      '1 – 3 adelantamientos → ×0.80',
      '0 adelantamientos → ×0.55',
      'Bonus posición: P1–P5 +0.05 | P6–P10 +0.025',
      'Factor acotado al rango 0.50 – 1.50.',
    ],
  },
  estratega: {
