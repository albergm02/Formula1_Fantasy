...
const realizarFichaje = (elemento) => {
  const resultado = partida.ficharElemento(elemento)
      ...
      <section>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div v-for="coche in cochesSemanales" :key="coche.id"
            class="aspect-[4/3] cursor-pointer hover:scale-[1.02] transition-transform" @click="realizarFichaje(coche)">
      ...
      <section>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div v-for="potenciador in potenciadoresSemanales" :key="potenciador.id"
            ...
            @click="realizarFichaje(potenciador)">
