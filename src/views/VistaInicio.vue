...
<template>
  <div class="min-h-screen w-full bg-[#15151e] p-4 pb-32 relative font-sans">
    <div class="mx-auto w-full max-w-5xl flex flex-col gap-8">
      ...
      <!-- Header fijo -->
      <header
        class="fixed top-0 left-0 w-full bg-[#15151e] border-b border-[#2e2e38] p-4 z-40 flex items-center justify-between">
      ...
      <main class="mt-28 flex flex-col gap-4 w-full">
        ...
        <Button @click="fantasyStore.resetearCuenta()" label="RESETEAR PARTIDA" icon="pi pi-trash"
