    ...
    <Card class="w-full max-w-md p-2 lg:p-4 !bg-black/20 backdrop-blur-md border border-zinc-800">
      ...
      <template #content>
        <Form
          ...
          @submit="handleCompletarPerfil"
        >
          <p class="text-center text-sm text-[#F0ECEC]">Es tu primera vez entrando con Google. Elige tu nombre de piloto para continuar.</p>

          <div class="flex flex-col gap-1">
            <label for="username" class="ml-1 text-xs font-bold uppercase tracking-wider text-[#F0ECEC]"> Nombre de Piloto </label>
            <InputText
              id="username"
              type="text"
              name="username"
