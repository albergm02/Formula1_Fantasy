<template>
  <div class="min-h-screen bg-[#15151E] font-sans pb-10">
      ...
      <div class="flex flex-col gap-6">
        <section class="grid grid-cols-2 gap-4">
          <Button
            label="CREAR LIGA"
            icon="pi pi-plus"
            class="w-full py-3 !bg-[#3C6E71] !border-none"
          ...
          <div v-if="ligasStore.ligasDetalles.length > 0" class="flex flex-col justify-center w-full">
            ...
            >
              ...
              <template #item="slotProps">
                <div
                  class="p-6 bg-[#15151E] rounded-2xl border-4 border-[#3C6E71] flex flex-col items-center gap-4"
                >
                  <div class="text-center w-full">
                    <h3
                      class="text-2xl font-black text-[#FF1E00] uppercase mb-2 w-full truncate px-10"
                  ...
                  <Button
                    label="ENTRAR"
                    class="w-full mt-2 !bg-[#FF1E00] !border-none !text-[#FFFFFF]"
    ...
    <!-- DIALOGO CREAR LIGA -->
    <Dialog
      v-model:visible="mostrarDialogoCrear"
      modal
    ...
    >
      <div class="flex flex-col gap-4">
        ...
        <InputText
          ...
          class="w-full !bg-[#111111] !text-[#D9D9D9] focus:!border-[#FF1E00]"
          autofocus
        />
        <div class="flex justify-end gap-2 mt-2">
          <Button
            label="Cancelar"
            @click="mostrarDialogoCrear = false"
    ...
    <Dialog
      v-model:visible="mostrarDialogoUnirse"
      modal
    ...
    >
      <div class="flex flex-col gap-4">
        ...
        <InputText
          ...
          class="w-full uppercase !bg-[#111111] focus:!border-[#3C6E71]"
          autofocus
        />
        <div class="flex justify-end gap-2 mt-2">
          <Button
            label="Cancelar"
            @click="mostrarDialogoUnirse = false"
            class="!bg-transparent !border-none !text-[#D9D9D9] hover:!text-white"
          />
          <Button
            label="Unirse"
