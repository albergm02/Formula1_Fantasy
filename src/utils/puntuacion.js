/* ─── 1. Pipeline principal del garaje ──────────────────────────────────────
   Punto de entrada del módulo. Orquesta todos los pasos del cálculo.        */
...
/* ─── 2. Factores de jornada por variante ───────────────────────────────────
   Despachador público → calculadores por variante → tablas de resolución.   */
...
/* ─── 3. Utilidades base de puntuación ──────────────────────────────────────
   Bloques primitivos usados por el pipeline.                                 */
