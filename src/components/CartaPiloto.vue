  ...
  <div class="flex flex-col gap-2 h-full w-full">
    ...
    >
      <div class="shrink-0 flex justify-between items-center p-2 bg-red-800 z-20">
        ...
        <span class="text-xs font-black">{{ piloto.precio }}M</span>
      </div>
      ...
      <div class="relative flex-1 min-h-0 w-full" @click="mostrarInfo = !mostrarInfo">
        ...
        <span
          ...
          class="absolute top-2 left-2 bg-black/80 text-white text-[10px] font-black px-2 py-1 rounded z-20"
          :class="{
            'bg-gray-500': piloto.tier === 'Q1',
            'bg-red-500': piloto.tier === 'Q2',
            'bg-purple-700': piloto.tier === 'Q3',
          }"
        >
          {{ piloto.tier }}
        </span>
