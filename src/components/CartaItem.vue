...
const etiquetaCondicion = computed(() => {
  ...
  const mapa = {
    ...
    carrera_limpia: { texto: 'Sólo cuenta en CARRERA LIMPIA (sin lluvia ni SC)', color: 'text-emerald-400', borde: 'border-emerald-500/40' },
    ...
    mis_remontadas: { texto: 'Sólo cuenta si UN PILOTO TUYO REMONTA 3+ POSICIONES', color: 'text-orange-400', borde: 'border-orange-500/40' },
    mis_pilotos_terminan: { texto: 'Sólo cuenta si TODOS TUS PILOTOS TERMINAN la carrera', color: 'text-green-400', borde: 'border-green-500/40' },
    mi_piloto_punto: { texto: 'Sólo cuenta si UN PILOTO TUYO acaba EN ZONA DE PUNTOS', color: 'text-cyan-400', borde: 'border-cyan-500/40' },
  }
      ...
      <div class="flex flex-col gap-4">
        ...
        <template v-if="esPiloto">
          ...
          <div class="flex flex-col gap-2 pb-3 border-b border-zinc-800">
            <p class="text-[10px] font-black uppercase tracking-widest" :style="{ color: colorVariante }">Cómo puntua
              esta variante</p>
