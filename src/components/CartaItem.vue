      ...
      <div class="flex flex-col gap-4">
            ...
            <div v-for="barra in barrasAtributos" :key="barra.nombre" class="space-y-0.5">
              <div class="flex justify-between items-center">
                ...
                <span class="text-[10px] font-black" :class="barra.peso > 0 ? 'text-white' : 'text-zinc-600'">
                  {{ barra.valor }}
                  <span :class="barra.peso > 0 ? 'text-zinc-500' : 'text-red-500'"> × {{ barra.peso }}</span>
                </span>
              </div>
        ...
        <template v-if="esPotenciador">
          ...
          <div v-if="etiquetasMejora.length">
            <p class="text-[10px] font-black uppercase tracking-widest text-zinc-400 mb-2">Mejoras de atributos</p>
            <div class="space-y-2">
