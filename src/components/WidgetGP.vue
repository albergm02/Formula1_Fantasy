...
async function fetchGranPremio() {
    ...
    return {
        ...
        fecha: new Date(proxima.date_start).toLocaleDateString('es-ES', { day: 'numeric', month: 'short', year: 'numeric' }),
        hora: new Date(proxima.date_start).toLocaleTimeString('es-ES', { hour: '2-digit', minute: '2-digit' }),
...
<template>
    <div class="bg-[#15151E] border border-zinc-800 rounded p-4 text-zinc-600">
        ...
        <div v-else class="flex flex-col items-center gap-2">
            <i class="pi pi-spinner animate-spin text-2xl text-zinc-500"></i>
